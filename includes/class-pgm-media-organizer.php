	...
	private function script_config() {
		...
		return array(
			...
			'i18n'            => array(
				...
				'privateMediaDiagnosticsHealthy' => __( 'Suojaus näyttää hyvältä.', 'private-gutenberg-media' ),
				...
				'noInheritedProtection' => __( 'Ei perittyä suojausta', 'private-gutenberg-media' ),
